...
package com.banasiak.android.nerdalert.ui.slidingtabs;
 ...
 * used for. <p> The colors can be customized in two ways. The first and simplest is to provide an
 * array of colors via {@link #setSelectedIndicatorColors(int...)} and {@link
 * #setDividerColors(int...)}. The alternative is via the {@link TabColorizer} interface which
 * provides you complete control over which color is used for any individual position. <p> The views
 * used as tabs can be customized by calling {@link #setCustomTabView(int, int)}, providing the
 * layout ID of your custom layout.
 */
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Sets the text color of the tab title without having to specify an entire layout for the
     * view.
     */
